...
class BotAgent:
    ...
    """
    Primary function of bot agent handles opening and checking order status
    """
    ...
    def __init__(
        ...
        self.accept_failsafe_base_price_side = accept_failsafe_base_price,
        ...
        # we are updating our self.order_dict[] function up top
    def check_order_status_by_id(self, order_id):
        
        # Allot time to process
        time.sleep(2)

        # Check order status
        order_status = check_order_status(self.client, order_id)

        # Guard: If orer cancelled moved onto next Pair
        ...
        if order_status != "FAILED":
            ...
            if order_status != "FILLED":
                ...
                self.order.dict["pair_status"] = "ERROR"
