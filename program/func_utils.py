...
def format_number(curr_num, match_num):
    ...
    # Give current number an example of number with dicimals dired
    #function will return currently formatted string

    curr_num_string = f"{curr_num}"
    match_num_string = f"{match_num}"

    #this is splitting the number before and after the decimal
...
def get_ISO_times():
    ...
    # Get timestamps - this gives about 16 days of data
